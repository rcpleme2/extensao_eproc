...
const chkRelAnaliseAtp = document.getElementById("chk-rel-analise-atp");
...
function lerOpcoesRelatorioUnidade() {
  return {
    ...
    analiseAtp: chkRelAnaliseAtp.checked,
...
const chkRelAltAnaliseAtp = document.getElementById("chk-relalt-analise-atp");
...
function lerOpcoesRelatorioUnidadeAlt() {
  return {
    ...
    analiseAtp: chkRelAltAnaliseAtp.checked,
